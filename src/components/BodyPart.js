...
const BodyPart = ({ item, setBodyPart, bodyPart }) => (
  <Paper
    ...
    className="bodyPart-card"
    sx={{
      border: bodyPart === item ? '2px solid #FF2625' : '2px solid #E5E5E5', // Border color changes based on selection
      borderRadius: '12px',
      boxShadow: 3,
      p: 2,
      width: '270px',
      ...
      backgroundColor: bodyPart === item ? '#FFFAFB' : '#FFFFFF', // Background color changes based on selection
      '&:hover': {
        boxShadow: 5,
      },
    }}
